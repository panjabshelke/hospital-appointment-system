  ...
  <div class="container mb-3 mt-3">
    <div class="row">
      <div class="col-lg-3 col-sm-3 col-6">
        ...
        <p><a href="<?= Yii::getAlias('@root') . DIRECTORY_SEPARATOR ?>about" class="">Read More...</a></p>
      </div>
      <div class="col-lg-3 col-sm-3 col-6">
        <h3>Quick links</h3>
        <ul>
          <li><a href="<?= Yii::getAlias('@root') ?>">HOME</a></li>
          <li><a href="<?= Yii::getAlias('@root') . DIRECTORY_SEPARATOR ?>about">ABOUT US</a></li>
          <li><a href="<?= Yii::getAlias('@root') . DIRECTORY_SEPARATOR ?>our-specifications">OUR SPECIFICATIONS</a></li>
          <li><a href="<?= Yii::getAlias('@root') . DIRECTORY_SEPARATOR ?>our-gallery">OUR GALLERY</a></li>
          <li><a href="<?= Yii::getAlias('@root') . DIRECTORY_SEPARATOR ?>our-branches">OUR BRANCHES</a></li>
          <li> <a href="<?= Yii::getAlias('@root') . DIRECTORY_SEPARATOR ?>contact">CONTACT US</a></li>
        </ul>
      </div>
...
<script type="text/javascript">
  function getSlotDetails() {
    var reservationDate = $("#reservationDatePopup").val();
    var branch_id = $("#branch_name").val();
    var doctor_id = $("#doctor_name").val();
    $('#available-time-slots-div').empty();
    if((branch_id == "" || branch_id == "Select Branch") && (doctor_id == "" || doctor_id == "Select Doctor" )) {
      alert("Select branch and doctor.");
      return false;
    }
    $('#timeslotPopup').removeClass('hide');
    $.ajax({
  ...
  $(document).ready(function() {
    ...
    $(".booking-form").on('change', '#branch_name,#doctor_name', function () {
        $("#reservationDatePopup").val("");
        $('#timeslotPopup').addClass('hide');
    });
    ...
    $(".booking-form").on('change', '#reservationDateTestPopup', function() {
